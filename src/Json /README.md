...
O Dicionário do Programador é o quadro semanal onde você poderá aprender mais sobre termos, tecnologias ou palavras do maravilhoso mundo da programação! O tema da vez é: JSON. [**``
JSON // Dicionário do Programador``**](https://youtu.be/P81dE-tkaaA)
